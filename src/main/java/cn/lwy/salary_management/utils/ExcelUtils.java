package cn.lwy.salary_management.utils;

import cn.lwy.salary_management.domain.e_d_j;
import cn.lwy.salary_management.exception.ExcelException;
...
//                dateStr = sb.toString();
    ...
    public void test1(){
        try {
           List<e_d_j> edj=new ArrayList<e_d_j>();
            employeeService employeeService1=new employeeServiceImpl();
            List<e_d_j> e_d_js = employeeService1.selectAll();
            ...
            listToExcel(e_d_js, fieldMap, "studentScore", fos);
